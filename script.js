...
const btnYo = document.querySelectorAll(".yo");
const nightMode = document.querySelector(".night__mode");

const modal2 = document.querySelector("#modal");
const modal1 = document.querySelector("#modal_Log");
...
nightMode.addEventListener("click", (e) => {
  ...
  if (modeClicked === 0) {
    ...
    navBar.style.setProperty("background-color", "#333333");
    ...
    document.querySelector("body").style.setProperty("color", "#444");
    navBar.style.setProperty("color", "#444");
    navBar.style.setProperty("background-color", "lightblue");
    modeClicked--;
  }
});
